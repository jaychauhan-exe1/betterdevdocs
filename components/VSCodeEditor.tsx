...
export default function VSCodeEditor({
  ...
  return (
    <div className="rounded-2xl border border-border/80 bg-card overflow-hidden flex flex-col shadow-lg">
      ...
      <div className="px-4 py-2 bg-secondary/40 border-b border-border/80 flex items-center justify-between select-none">
        {/* File Name Label */}
        ...
        <div className="flex items-center gap-2">
          {onReset && (
            <Button
              ...
              size="sm"
              onClick={onReset}
              className="text-xs text-muted-foreground hover:text-foreground h-7 px-2 gap-1 font-medium"
              title="Reset Code"
            >
          ...
          {onRun && (
            <Button
              ...
              className="bg-secondary hover:bg-secondary/80 text-foreground border border-border/80 font-semibold text-xs h-7 px-3 gap-1.5 rounded-lg shadow-sm"
          ...
          {onSubmit && (
            <Button
              onClick={onSubmit}
              disabled={isRunning || isSubmitting}
              className="bg-emerald-500 hover:bg-emerald-600 text-black font-bold text-xs h-7 px-3.5 gap-1.5 rounded-lg shadow-sm"
