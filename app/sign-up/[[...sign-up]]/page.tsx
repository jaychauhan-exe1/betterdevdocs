    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-black text-foreground p-4 overflow-hidden">
      ...
      <div className="z-10 w-full max-w-md flex flex-col items-center gap-6">
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <h1 className="text-xl font-bold tracking-tight text-foreground">Create your DevDocs account</h1>
          <p className="text-xs text-muted-foreground">Start learning, building, and tracking your dev skills</p>
        </div>
